...
namespace WebApplication1.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="DBWebPhim")]
    ...
    partial void DeleteYoutubeReview(YoutubeReview instance);
        ...
        public MyDataDataContext() :
                base(global::System.Configuration.ConfigurationManager.ConnectionStrings["DBWebPhimConnectionString"].ConnectionString, mappingSource)
        {
            OnCreated();
        }
    ...
    partial void OnComingSoonChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movy_MovieSeat", Storage="_MovieSeats", ThisKey="MovieID", OtherKey="MovieID")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.MovieSeat")]
    ...
    partial void OnF16Changed();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MovieSeat_Ticket", Storage="_Tickets", ThisKey="MalID", OtherKey="MalID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Movy_MovieSeat", Storage="_Movy", ThisKey="MovieID", OtherKey="MovieID", IsForeignKey=true)]
		public Movy Movy
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MovieTheater_MovieSeat", Storage="_MovieTheater", ThisKey="TheaterID", OtherKey="TheaterID", IsForeignKey=true)]
		...
		{
			this.SendPropertyChanging();
			entity.MovieSeat = this;
		}
		
		private void detach_Tickets(Ticket entity)
		{
			this.SendPropertyChanging();
			entity.MovieSeat = null;
		}
	}
    ...
    partial void OnAddressChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MovieTheater_MovieSeat", Storage="_MovieSeats", ThisKey="TheaterID", OtherKey="TheaterID")]
		public EntitySet<MovieSeat> MovieSeats
		{
			get
			{
    ...
    partial void OnLogoChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="Theater", Storage="_Theater1", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
	...
	public partial class Ticket : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<MovieSeat> _MovieSeat;
    ...
    partial void OnAmountSeatsChanged();
		...
		public Ticket()
		{
			this._MovieSeat = default(EntityRef<MovieSeat>);
			this._User = default(EntityRef<User>);
			OnCreated();
		}
		...
		public int MalID
		{
			...
			set
			{
				if ((this._MalID != value))
				{
					if (this._MovieSeat.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnMalIDChanging(value);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="MovieSeat_Ticket", Storage="_MovieSeat", ThisKey="MalID", OtherKey="MalID", IsForeignKey=true)]
		public MovieSeat MovieSeat
		{
			get
			{
				return this._MovieSeat.Entity;
			}
			set
			{
				MovieSeat previousValue = this._MovieSeat.Entity;
				if (((previousValue != value) 
							|| (this._MovieSeat.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._MovieSeat.Entity = null;
						previousValue.Tickets.Remove(this);
					}
					this._MovieSeat.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("MovieSeat");
				}
			}
		}
